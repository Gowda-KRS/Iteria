...
define(
  ...
  showOrdersPage : function() {
    ...
    getIncompleOrderDetailsFailure : function (pResult) {
      var widget = this;
      notifier.sendError(widget.WIDGET_ID, CCi18n.t('ns.agentcustomerprofiledetails:resources.profileLoadOrderError'));
    },
    ...
    updateCartText : function(pData) {
      ...
      if(pData && pData.items && pData.items.length > 0) {
        ...
        var createNewOrderText =  CCi18n.t('ns.agentcustomerprofiledetails:resources.createOrderLink');
  ...
  getIncompleteOrderText : function(pData) {
    ...
    linkText = CCi18n.t("ns.agentcustomerprofiledetails:resources." + resourceKey, {
      count : numItems,
