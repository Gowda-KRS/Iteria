...
define(
  ...
  function (ko, CCRestClient, $, CCi18n, CCConstants, notifier, PubSub, Organization, siteListingViewModel, spinner, agentConfiguration, accountAndSiteSelector, DynamicPropertyMetaContainer) {
    ...
    return {
      ...
      /*rahul 30/08/21*/
      dyProp_syteLineID: ko.observable(),
      dyProp_Primarybusiness: ko.observable(),
      dyProp_Secondarybusiness: ko.observable(),
      dyProp_Organizationtype: ko.observable(),
      dyProp_Numberofemp: ko.observable(),
      dyProp_Annualrevenue: ko.observable(),
      dyProp_Terms: ko.observable(),
      dyProp_Creditlimit: ko.observable(),
      // Spinner resources
      ...
      console.log("lengthhh", user.dynamicProperties().length);
      console.log("datcheck", user.dynamicProperties());
          for(var i = 0; i<user.dynamicProperties().length; i++){
         if(user.dynamicProperties()[i].id() == "SyteLine_Cust_ID"){
             widget.dyProp_syteLineID(user.dynamicProperties()[i].value());
             console.log("syteLineIdCheck", widget.dyProp_syteLineID());
         }else if(user.dynamicProperties()[i].id() == "primary_business"){
             widget.dyProp_Primarybusiness(user.dynamicProperties()[i].value());
             console.log("syteLineIdCheck", widget.dyProp_Primarybusiness());
         }else if(user.dynamicProperties()[i].id() == "secondary_business"){
             widget.dyProp_Secondarybusiness(user.dynamicProperties()[i].value());
             console.log("syteLineIdCheck", widget.dyProp_Secondarybusiness());
         }else if(user.dynamicProperties()[i].id() == "org_type"){
             widget.dyProp_Organizationtype(user.dynamicProperties()[i].value());
             console.log("syteLineIdCheck", widget.dyProp_Organizationtype());
         }else if(user.dynamicProperties()[i].id() == "num_of_employees"){
             widget.dyProp_Numberofemp(user.dynamicProperties()[i].value());
             console.log("syteLineIdCheck", widget.dyProp_Numberofemp());
         }else if(user.dynamicProperties()[i].id() == "annual_revenue"){
             widget.dyProp_Annualrevenue(user.dynamicProperties()[i].value());
             console.log("syteLineIdCheck", widget.dyProp_Annualrevenue());
         }else if(user.dyProp_Terms()[i].id() == "x_terms"){
             widget.dyProp_Primarybusiness(user.dynamicProperties()[i].value());
             console.log("syteLineIdCheck", widget.dyProp_Terms());
         }else if(user.dynamicProperties()[i].id() == "x_creditLimit"){
             widget.dyProp_Creditlimit(user.dynamicProperties()[i].value());
             console.log("syteLineIdCheck", widget.dyProp_Creditlimit());
         }
      }
