...
define(
  ...
  return {
    ...
    console.log("lifygate", widget.dyProp_SpecialdeliveryIn());
    }else if(widget.dynamicProperties()[j].id() == "x_main_contact"){
    widget.dyProp_Maincontact(widget.dynamicProperties()[j].value());
    console.log("billing", widget.dyProp_Maincontact());
    }/*else if(orgDetails[j].id() == "INDE_INPU"){
    widget. dyProp_Insidepickupdlr(orgDetails[j].value());
    console.log("lifygate", widget. dyProp_Insidepickupdlr());
    }else if(orgDetails[j].id() == "LIFT_GATE"){
    widget.dyProp_LiftGate(orgDetails[j].value());
    console.log("lifygate", widget.dyProp_LiftGate());
    }else if(orgDetails[j].id() == "RESI_PU_DEL"){
    widget.dyProp_ResidentialPickup(orgDetails[j].value());
    console.log("billing", widget.dyProp_ResidentialPickup());
    }else if(orgDetails[j].id() == "LAPU_LADL"){
    widget.dyProp_LimitedAcc(orgDetails[j].value());
    console.log("billing", widget.dyProp_LimitedAcc());
    }else if(orgDetails[j].id() == "x_main_contact"){
    widget.dyProp_Maincontact(orgDetails[j].value());
    console.log("billing", widget.dyProp_Maincontact());
    }else if(orgDetails[j].id() == "x_billing_contact"){
    widget.dyProp_billingContact(orgDetails[j].value());
    console.log("billing", widget.dyProp_billingContact());
    }else if(orgDetails[j].id() == "x_shipping_contact"){
    widget.dyProp_ShippingContact(orgDetails[j].value());
    console.log("billing", widget.dyProp_ShippingContact());
    }else if(orgDetails[j].id() == "Address_Status"){
    widget.dyProp_AddressStatus(orgDetails[j].value());
    console.log("billing", widget.dyProp_AddressStatus());
    }
    }*/}
      },3000);
